...
public class Simbolo {
   ...
   public final void setValor(br.ucb.calango.simbolos.Simbolo valor) throws TiposIncompativeisException {
   ...
   public final SimboloLiteral add(br.ucb.calango.simbolos.Simbolo simbolo) {
      Class<?> tipo = null;
      Object valor = null;
   ...
   public final SimboloLiteral sub(br.ucb.calango.simbolos.Simbolo simbolo) {
      Class<?> tipo = null;
      Object valor = null;
   ...
   public final SimboloLiteral mult(br.ucb.calango.simbolos.Simbolo simbolo) {
      Class<?> tipo = null;
      Object valor = null;
   ...
   public final SimboloLiteral div(br.ucb.calango.simbolos.Simbolo simbolo) {
      Class<?> tipo = null;
      Double valor = null;
   ...
   public br.ucb.calango.simbolos.Simbolo divInt(br.ucb.calango.simbolos.Simbolo simbolo) {
      return new SimboloLiteral(Integer.class, this.div(simbolo).getValor());
   }

   public final SimboloLiteral mod(br.ucb.calango.simbolos.Simbolo simbolo) {
      Class<?> tipo = null;
      Object valor = null;
   ...
   public SimboloLiteral igual(br.ucb.calango.simbolos.Simbolo s) {
   ...
   public boolean isCompativel(br.ucb.calango.simbolos.Simbolo outro) {
