...
public class SymbolChecker {
   private br.ucb.calango.symbolchecker.Escopo global = new br.ucb.calango.symbolchecker.Escopo();
   private br.ucb.calango.symbolchecker.Escopo local = null;
      ...
      if (tree != null) {
         ...
         if (children != null) {
            ...
            for(Iterator var4 = children.iterator(); var4.hasNext(); this.checkRecursively(subtree)) {
               ...
               case 44:
               case 78:
                  this.local = new br.ucb.calango.symbolchecker.Escopo();
                  break;
               case 46:
