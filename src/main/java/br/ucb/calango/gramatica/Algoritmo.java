...
public class Algoritmo {
   ...
   private static br.ucb.calango.gramatica.Algoritmo algoritmo = null;
   ...
   private static br.ucb.calango.gramatica.Algoritmo getCurrentInstance() {
      if (algoritmo == null) {
         algoritmo = new br.ucb.calango.gramatica.Algoritmo();
      }
